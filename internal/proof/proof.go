...
func GetNewProofRange(account common.Address, startingVersion, endingVersion uint64, precomputedData *config.PrecomputedData, blockOffset uint64, db *pebble.DB) ([]*RangeProof, []*segmenttree.HistoricalBalance) {
