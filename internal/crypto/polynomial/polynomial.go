...
// func NewFromSegmentTree(segmentTree tree.SegmentTree, currentBlockNumber int, cachedPolynomial Polynomial, V Polynomial, weights []fr.Element) (Polynomial, error) {
